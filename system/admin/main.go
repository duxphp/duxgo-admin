...
func Main(ctx echo.Context) error {
	...
	//}
	//
	//var apiTimeMax []*statsData
	//var apiTimeMin []*statsData
	...
	//
	//var apiTimeMaxMaps []map[string]any
	//err = mapstructure.Decode(apiTimeMax, &apiTimeMaxMaps)
	//if err != nil {
	//	return err
	//}
	//var apiTimeMinMaps []map[string]any
	...
	//
	//var fileNumMaps []map[string]any
	...
	//
	//var operateMaps []map[string]any
	...
	return response.New(ctx).Render("adminHome.gohtml", nil)
}
